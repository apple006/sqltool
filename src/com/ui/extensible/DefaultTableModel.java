...
//
    ...
    public Object getHeadObject(int i){
    	return columnIdentifiers.get(i);
    }
    /**
...
// 
     ...
     */
    public void addColumn(Object columnName, Cell[] columnData) {
...
//
    ...
    public boolean isCellEditable(int row, int column) {
    	Cell valueAt = (Cell) this.getValueAt(row, column);
    	valueAt.setOld_value(valueAt.getNew_value());
        return true;
    }
