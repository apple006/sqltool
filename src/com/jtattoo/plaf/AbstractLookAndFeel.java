...
abstract public class AbstractLookAndFeel extends MetalLookAndFeel {
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Object[] defaults = {
            ...
            "TabbedPane.tabAreaInsets", new InsetsUIResource(0,0 , 5, 5),
            "TabbedPane.contentBorderInsets", new InsetsUIResource(0, 5, 5, 5),
            "TabbedPane.tabInsets", new InsetsUIResource(0, 15, 0, 15),
