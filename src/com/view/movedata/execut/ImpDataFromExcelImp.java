...
public class ImpDataFromExcelImp extends Execute{
	public ImpDataFromExcelImp(LoginInfo loginfo) {
		super(loginfo);
	}
	/**
	 * 块缓存数据大小
	...
	public ImpDataFromExcelImp(LoginInfo loginfo,ImpDataBaseCtr ctr){
		this(loginfo);
		this.ctr = ctr;
	}
	@Override
