...
public class QueryDataResFileImp extends Execute implements IExpQuery{
		...
		public QueryDataResFileImp(ExpDataToFileCtr ctr){
		...
		public void run() {
			...
			try {
				System.out.println(ctr.getTableName()+"准备Connection");

				connection = getConnection();
				System.out.println(ctr.getTableName()+"去成功");
